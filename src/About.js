      ...
      <h3>About&nbsp;Me</h3>
        <div className="about-content">
          <div className="about-text">
            ...
            <p>I'm originally from Portugal but I moved to the Bay Area in 2013. Since then I have worked at <a href="https://www.zendesk.com" target="_blank" rel="noopener noreferrer">Zendesk</a>, <a href="https://www.postmates.com" target="_blank" rel="noopener noreferrer">Postmates</a> and <a href="https://www.onemedical.com" target="_blank" rel="noopener noreferrer">One Medical</a>.</p>
