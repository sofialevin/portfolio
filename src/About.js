    ...
    <div className="about-content">
      <div className="about-text">
        ...
        <p>
          ...
          {' '}
          <a href="https://www.zendesk.com" target="_blank" rel="noopener noreferrer" aria-label="Zendesk.com">Zendesk</a>
          ,
          {' '}
          <a href="https://www.postmates.com" target="_blank" rel="noopener noreferrer" aria-label="Postmates.com">Postmates</a>
          {' '}
          and
          {' '}
          <a href="https://www.onemedical.com" target="_blank" rel="noopener noreferrer" aria-label="One Medical.com">One Medical</a>
          .
        </p>
