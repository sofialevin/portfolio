      ...
      <h3>About Me</h3>
        <div className="about-content">
          <div className="about-text">
            ...
            <p>When I'm not coding, I still mostly try to build and make things. My current favorites are knitting and baking but give me an idea and some tools and I will try to make something awesome!</p>
          </div>
