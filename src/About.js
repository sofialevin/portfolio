    ...
    <div className="about-content">
      <div className="about-text">
        ...
        <p>
          ...
          ,
          {' '}
          <a href="https://www.postmates.com" target="_blank" rel="noopener noreferrer">Postmates</a>
          {' '}
          and
          {' '}
          <a href="https://www.onemedical.com" target="_blank" rel="noopener noreferrer">One Medical</a>
          .
        </p>
