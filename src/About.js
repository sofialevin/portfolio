      ...
      <h3>About Me</h3>
        <div className="about-content">
          <div className="about-text">
            ...
            <p>When I'm not coding, I still mostly try to build and make things. My current favorites are knitting and baking, but I'm always open to new projects... if you send me and idea and some tools I will make something awesome!</p>
          </div>
